...
def main():
    ...
    back_button['command'] = lambda: handle_back(mqtt_client, left_speed_entry, right_speed_entry)
    root.bind('<Down>', lambda event: handle_back(mqtt_client, left_speed_entry, right_speed_entry))
