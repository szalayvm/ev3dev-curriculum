...
#   Tests @ 10 seconds:
#     100 degrees / second  -->  traveled 13 inches  -->  1.33 inches / second
#     200 degrees / second  -->  traveled 24 inches  -->  2.4 inches / second
#     300 degrees / second  -->  traveled 35 inches  -->  3.5 inches / second
#     400 degrees / second  -->  traveled 44 inches  -->  4.4 inches / second
#   Tests @ 5 seconds:
#     500 degrees / second  -->  traveled 27 inches  -->  5.4 inches / second
#     600 degrees / second  -->  traveled 34.5 inches  -->  6.9 inches / second
#     700 degrees / second  -->  traveled 38 inches  -->  7.6 inches / second
#     800 degrees / second  -->  traveled 38 inches  -->  7.6 inches / second
#     900 degrees / second  -->  traveled 38 inches  -->  7.6 inches / second (probably no faster than 800)
#
...
def main():
    ...
    while time_s != 0:
        speed = int(input("Enter a speed(0 to 900): "))
        dist = int(input("Distance to travel(inches): "))
        speedInchesSec = speed * .0106
        sec = dist/speedInchesSec
