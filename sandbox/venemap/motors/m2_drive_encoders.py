...
def main():
    ...
    while time_s != 0:
        ...
        degreeToInch = 90
        deg = dist * degreeToInch

        left_motor.run_to_rel_pos(speed_sp=speed, position_sp=deg, stop_action='brake')
        right_motor.run_to_rel_pos(speed_sp=speed, position_sp=deg, stop_action='brake')
